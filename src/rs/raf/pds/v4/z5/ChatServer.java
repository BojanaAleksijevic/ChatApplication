...
public class ChatServer implements Runnable{
	...
	private void broadcastChatMessage(ChatMessage message, Connection exception) {
	    ...
	    if (text.contains(":")) {
	        ...
	        if (recipientConnection != null && recipientConnection != exception) {
